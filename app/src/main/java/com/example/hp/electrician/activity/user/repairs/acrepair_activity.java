...
public class acrepair_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acrepair_activity);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
               ...
               if (orderInfo.getId() == "acrepair3") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add3.setText("Item");
                        } else {
                            add3.setText("" + dataSnapshot.child("acrepair3").child("no_of_items").getValue(Integer.class));
                        }
                    }

                    if (orderInfo.getId() == "acrepair4") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add4.setText("Item");
                        } else {
                            add4.setText("" + dataSnapshot.child("acrepair4").child("no_of_items").getValue(Integer.class));
                        }
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(acrepair_activity.this,"Error", Toast.LENGTH_SHORT).show();
            }
        ...
        llac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(acrepair_activity.this, cart_activity.class);
                //intent.putExtra("type","acrepair");
        ...
        buttonac3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                orderInfo.setId("acrepair3");
                orderInfo.setService1(s1);
                i++;
                orderInfo.setNo_of_items(i);
                orderInfo.setPrice1(i*p1);
                databaseReference.child("acrepair3").setValue(orderInfo);
        ...
        buttonac4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                OrderInfo orderInfo = new OrderInfo();
                orderInfo.setId("acrepair4");
                orderInfo.setService1(s1);
                j++;
                orderInfo.setNo_of_items(j);
                orderInfo.setPrice1(j*p1);
                databaseReference.child("acrepair4").setValue(orderInfo);
        ...
        buttonac4n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (j > 0) {
                    ...
                    if(j==0)
                    {
                        databaseReference.child("acrepair4").removeValue();
                    }
                } else {
                    databaseReference.child("acrepair4").removeValue();
                    add4.setText("Item");
                    Toast.makeText(acrepair_activity.this, "You cannot subtract items lesser than 0", Toast.LENGTH_SHORT).show();
                }
        ...
        buttonac3n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i > 0) {
                    ...
                    if(i==0)
                    {
                        databaseReference.child("acrepair3").removeValue();
                    }
                } else {
                    databaseReference.child("acrepair3").removeValue();
                    add3.setText("Item");
