...
public class fan_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (orderInfo.getId() == "fan3") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add3.setText("Item");
                        } else {
                            add3.setText("" + dataSnapshot.child("fan3").child("no_of_items").getValue(Integer.class));
                        }
                    }

                    if (orderInfo.getId() == "fan4") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add4.setText("Item");
                        } else {
                            add4.setText("" + dataSnapshot.child("fan4").child("no_of_items").getValue(Integer.class));
                        }
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(fan_activity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        ...
        llac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(fan_activity.this, cart_activity.class);
        ...
        buttonac4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                OrderInfo orderInfo = new OrderInfo();
                orderInfo.setId("fan4");
                orderInfo.setService1(s1);
                j++;
                orderInfo.setNo_of_items(j);
                orderInfo.setPrice1(j * p1);
                databaseReference.child("fan4").setValue(orderInfo);
...

    {
        ...
        if (j > 0) {
            ...
            add4.setText("" + orderInfo.getNo_of_items());
            if (j == 0) {
                databaseReference.child("fan4").removeValue();
            }
        } else {
            databaseReference.child("fan4").removeValue();
            add4.setText("Item");
            Toast.makeText(fan_activity.this, "You cannot subtract items lesser than 0", Toast.LENGTH_SHORT).show();
        }
...

    {
        ...
        if (i > 0) {
            ...
            add3.setText("" + orderInfo.getNo_of_items());
            if (i == 0) {
                databaseReference.child("fan3").removeValue();
            }
        } else {
            databaseReference.child("fan3").removeValue();
            add3.setText("Item");
