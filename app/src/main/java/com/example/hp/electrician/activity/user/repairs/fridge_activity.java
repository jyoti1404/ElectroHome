...
public class fridge_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fridge_activity);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (orderInfo.getId() == "fridge3") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add3.setText("Item");
                        } else {
                            add3.setText("" + dataSnapshot.child("fridge3").child("no_of_items").getValue(Integer.class));
                        }
                    }

                    if (orderInfo.getId() == "fridge4") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add4.setText("Item");
                        } else {
                            add4.setText("" + dataSnapshot.child("fridge4").child("no_of_items").getValue(Integer.class));
                        }
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(fridge_activity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        ...
        llac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(fridge_activity.this, cart_activity.class);
        ...
        buttonac4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                OrderInfo orderInfo = new OrderInfo();
                orderInfo.setId("fridge4");
                orderInfo.setService1(s1);
                j++;
                orderInfo.setNo_of_items(j);
                orderInfo.setPrice1(j*p1);
                databaseReference.child("fridge4").setValue(orderInfo);
        ...
        buttonac4n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (j > 0) {
                    ...
                    if(j==0)
                    {
                        databaseReference.child("fridge4").removeValue();
                    }
                } else {
                    databaseReference.child("fridge4").removeValue();
                    add4.setText("Item");
                    Toast.makeText(fridge_activity.this, "You cannot subtract items lesser than 0", Toast.LENGTH_SHORT).show();
                }
        ...
        buttonac3n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i > 0) {
                    ...
                    if(i==0)
                    {
                        databaseReference.child("fridge3").removeValue();
                    }
                } else {
                    databaseReference.child("fridge3").removeValue();
                    add3.setText("Item");
