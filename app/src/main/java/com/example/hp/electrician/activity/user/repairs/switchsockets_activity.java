...
public class switchsockets_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_switchsockets_activity);
        ...
        setTitle("Switches/Sockets Repairs");
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    OrderInfo orderInfo = dataSnapshot1.getValue(OrderInfo.class);
                    if (orderInfo.getId() == "ss3") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add3.setText("Item");
                        } else {
                            add3.setText("" + dataSnapshot.child("ss3").child("no_of_items").getValue(Integer.class));
                        }
                    }

                    if (orderInfo.getId() == "ss4") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add4.setText("Item");
                        } else {
                            add4.setText("" + dataSnapshot.child("ss4").child("no_of_items").getValue(Integer.class));
                        }
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(switchsockets_activity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        ...
        llac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(switchsockets_activity.this, cart_activity.class);
        ...
        buttonac3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("ss3").setValue(orderInfo);
        ...
        buttonac4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("ss4").setValue(orderInfo);
        ...
        buttonac4n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (j > 0) {
                    ...
                    if(j==0)
                    {
                        databaseReference.child("ss4").removeValue();
                    }
                } else {
                    databaseReference.child("ss4").removeValue();
                    add4.setText("Item");
                    Toast.makeText(switchsockets_activity.this, "You cannot subtract items lesser than 0", Toast.LENGTH_SHORT).show();
                }
        ...
        buttonac3n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i > 0) {
                    ...
                    if(i==0)
                    {
                        databaseReference.child("ss3").removeValue();
                    }
                } else {
                    databaseReference.child("ss3").removeValue();
                    add3.setText("Item");
