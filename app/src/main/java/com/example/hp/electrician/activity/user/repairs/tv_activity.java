    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (orderInfo.getId() == "tv3") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add3.setText("Item");
                        } else {
                            add3.setText("" + dataSnapshot.child("tv3").child("no_of_items").getValue(Integer.class));
                        }
                    }

                    if (orderInfo.getId() == "tv4") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add4.setText("Item");
                        } else {
                            add4.setText("" + dataSnapshot.child("tv4").child("no_of_items").getValue(Integer.class));
                        }
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(tv_activity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        ...
        llac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(tv_activity.this, cart_activity.class);
        ...
        buttonac3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("tv3").setValue(orderInfo);
        ...
        buttonac4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("tv4").setValue(orderInfo);
            ...
            public void onClick(View v) {
                ...
                if (j > 0) {
                   ...
                   add4.setText("" + orderInfo.getNo_of_items());
                    if(j==0)
                    {
                        databaseReference.child("tv4").removeValue();
                    }
                } else {
                    databaseReference.child("tv4").removeValue();
                    add4.setText("Item");
                    Toast.makeText(tv_activity.this, "You cannot subtract items lesser than 0", Toast.LENGTH_SHORT).show();
                }
        ...
        buttonac3n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i > 0) {
                    ...
                    if(i==0)
                    {
                        databaseReference.child("tv3").removeValue();
                    }
                } else {
                    databaseReference.child("tv3").removeValue();
                    add3.setText("Item");
