...
public class roservice_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roservice_activity);
        ...
        setTitle("RO/Water Purifier Services");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (orderInfo.getId() == "ro1") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add1.setText("Item");
                        } else {
                            add1.setText("" + dataSnapshot.child("ro1").child("no_of_items").getValue(Integer.class));
                        }
                    }
                    if (orderInfo.getId() == "ro2") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add2.setText("Item");
                        } else {
                            add2.setText("" + dataSnapshot.child("ro2").child("no_of_items").getValue(Integer.class));
                        }
                    }
                    if (orderInfo.getId() == "ro3") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add3.setText("Item");
                        } else {
                            add3.setText("" + dataSnapshot.child("ro3").child("no_of_items").getValue(Integer.class));
                        }
                    }

                    if (orderInfo.getId() == "ro4") {
                        if (orderInfo.getNo_of_items() == 0) {
                            add4.setText("Item");
                        } else {
                            add4.setText("" + dataSnapshot.child("ro4").child("no_of_items").getValue(Integer.class));
                        }
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(roservice_activity.this,"Error", Toast.LENGTH_SHORT).show();
            }
        ...
        llac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(roservice_activity.this, cart_activity.class);
        ...
        buttonac3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("ro3").setValue(orderInfo);
        ...
        buttonac4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("ro4").setValue(orderInfo);
        ...
        buttonac2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("ro2").setValue(orderInfo);
...

        {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("ro1").setValue(orderInfo);
        ...
        buttonac1n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (l > 0) {
                    ...
                    if(l==0)
                    {
                        databaseReference.child("ro1").removeValue();
                    }
                } else {
                    databaseReference.child("ro1").removeValue();
                    add1.setText("Item");
                    Toast.makeText(roservice_activity.this, "You cannot subtract items lesser than 0", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buttonac4n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (j > 0) {
                    ...
                    if(j==0)
                    {
                        databaseReference.child("ro4").removeValue();
                    }
                } else {
                    databaseReference.child("ro4").removeValue();
                    add4.setText("Item");
        ...
        buttonac2n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (k > 0) {
                    ...
                    if(k==0)
                    {
                        databaseReference.child("ro2").removeValue();
                    }
                } else {
                    databaseReference.child("ro2").removeValue();
                    add2.setText("Item");
        ...
        buttonac3n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i > 0) {
                    ...
                    if(i==0)
                    {
                        databaseReference.child("ro3").removeValue();
                    }
                } else {
                    databaseReference.child("ro3").removeValue();
                    add3.setText("Item");
